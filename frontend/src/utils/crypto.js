...
const SECRET_KEY = import.meta.env.VITE_STORAGE_KEY || 'prolecom_secure_key_2026_default';
...
export const storage = {
  ...
  decryptPayload: (base64Data) => {
    try {
      const keyStr = import.meta.env.VITE_STORAGE_KEY || 'prolecom_secure_key_2026_xyz';
