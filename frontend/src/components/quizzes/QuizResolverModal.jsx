...
const SinIntentosView = ({ quiz, handleCloseModal }) => (
...
SinIntentosView.propTypes = {
  quiz: PropTypes.object.isRequired,
  handleCloseModal: PropTypes.func.isRequired,
};

const ResultadoIntentoView = ({ quiz, resultadoIntento, handleCloseModal }) => (
...
ResultadoIntentoView.propTypes = {
  quiz: PropTypes.object.isRequired,
  resultadoIntento: PropTypes.object.isRequired,
  handleCloseModal: PropTypes.func.isRequired,
};
      ...
      <div ref={mainContainerRef} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {sinIntentosPermitidos && (
            <SinIntentosView quiz={quiz} handleCloseModal={handleCloseModal} />
          )}

          {!sinIntentosPermitidos && resultadoIntento && (
            <ResultadoIntentoView quiz={quiz} resultadoIntento={resultadoIntento} handleCloseModal={handleCloseModal} />
          )}
