...
class ClienteDashboard extends BaseDashboard
{
    ...
    protected function getActividades(): array
    {
        ...
        $notificaciones = $this->fetchNotificaciones();
        ...
        $materiales = $this->fetchMaterialesActividades($cursosEstudiante);
        $desafios = $this->fetchDesafiosActividades($cursosEstudiante);
        $quizzes = $this->fetchQuizzesActividades($cursosEstudiante);
        $foros = $this->fetchForosActividades($cursosEstudiante);
        $temas = $this->fetchTemasActividades($cursosEstudiante);
    ...
    private function fetchNotificaciones(): array
    {
    ...
    private function fetchMaterialesActividades(array $cursosEstudiante): array
    {
        if (! Schema::hasTable('materiales_aprendizaje')) {
            return [];
        }

        return DB::table('materiales_aprendizaje')
    ...
    private function fetchDesafiosActividades(array $cursosEstudiante): array
    {
    ...
    private function fetchQuizzesActividades(array $cursosEstudiante): array
    {
    ...
    private function fetchForosActividades(array $cursosEstudiante): array
    {
        if (! Schema::hasTable('foros')) {
            return [];
        }

        return DB::table('foros')
    ...
    private function fetchTemasActividades(array $cursosEstudiante): array
    {
